<%@ Page Title="" Language="VB" MasterPageFile="~/site.master" AutoEventWireup="false" CodeFile="fieldEmpSelect.aspx.vb" Inherits="Main_fieldEmpSelect" %>
    ...
    <asp:Table ID="tblEmp" runat="server" CssClass="DATA" GridLines="None" HorizontalAlign="Center" Width="450px">
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center">
                <asp:Label ID="Label1" runat="server" Text="Select an Employee" CssClass="DATA_LABEL"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
