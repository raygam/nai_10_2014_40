...
Partial Class Main_fieldEmpSelect
    ...
    Sub FillEmpsBox(m_dist As String)
        Dim ds As DataSet = EmpSys.GetFieldEmps(m_dist)
        With ddlEmps
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim strDist As String = Request.Params("dist")
